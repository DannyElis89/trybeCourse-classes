...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(Object.keys(objetoRetornado).includes('fetchMenu')).toBe(true);
    ...
    expect(typeof objetoRetornado.fetchMenu()).toEqual('object');
    ...
    expect(objetoRetornado.fetchMenu() === objetoQualquer).toBe(true)
    ...
    expect((objetoRetornado.consumption).includes('coxinha')).toBe(true);
    ...
    // ```
    expect((objetoRetornado.consumption).includes('coxinha')).toBe(true);
    expect((objetoRetornado.consumption).includes('agua')).toBe(true);
    expect((objetoRetornado.consumption).includes('sopa')).toBe(true);
    expect((objetoRetornado.consumption).includes('sashimi')).toBe(true);
    ...
    expect(objetoRetornado.pay()).toEqual(parseFloat(29.75).toFixed(2));
