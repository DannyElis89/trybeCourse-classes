...
describe(`10 - Visualize a lista de produtos adicionados ao carrinho em sua página e permita a manipulação da sua quantidade`, () => {
  it('Adiciona produtos ao carrinho e manipula suas quantidades', async () => {
    ...
    // console.log(screen.getAllByTestId('product-add-to-cart'));
    fireEvent.click(screen.getAllByTestId('product-add-to-cart')[0]);
    fireEvent.click(screen.getAllByTestId('product-add-to-cart')[1]);
    // console.log(screen.getAllByTestId('product-add-to-cart')[0])
    // console.log(screen.getAllByTestId('product-add-to-cart')[1])
    // console.log(screen.getAllByTestId('product')[1]);
    ...
    // console.log(screen.getAllByTestId('shopping-cart-product-name'));
    ...
    // console.log(screen.getAllByTestId('shopping-cart-product-name')[0]);
    // console.log(screen.getAllByTestId('shopping-cart-product-name')[1]);
