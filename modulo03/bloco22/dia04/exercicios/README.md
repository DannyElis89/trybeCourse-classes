...
Este endpoint deve cadastrar novos personagens.
    ...
    * Caso a personagem ainda não exista, adicione-a ao arquivo `simpsons.json` e devolva um body vazio com o status `204 - No Content`. Para encerrar a request sem enviar nenhum dado, você pode utilizar `;`.
