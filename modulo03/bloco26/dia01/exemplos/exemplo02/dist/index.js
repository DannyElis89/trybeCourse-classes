...
console.log(`Losango de D = 32cm e d = 18cm: ${Exercise.losange(32, 18)}cm²`);
console.log(`Losango de D = 200cm e d = 50cm: ${Exercise.losange(200, 50)}cm²`);
console.log(`Losango de D = 75cm e d = 25cm: ${Exercise.losange(75, 25)}cm²`);
console.log(`Trapézio de B = 100cm, b = 70cm e altura = 50cm: ${Exercise.trapeze(100, 70, 50)}cm²`);
console.log(`Trapézio de B = 75cm, b = 50cm e altura = 35cm: ${Exercise.trapeze(75, 50, 35)}cm²`);
console.log(`Trapézio de B = 150cm, b = 120cm e altura = 80cm: ${Exercise.trapeze(150, 120, 80)}cm²`);
