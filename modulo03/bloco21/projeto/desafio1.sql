...
CREATE TABLE SpotifyClone.usuario_musicas(
	user_id INT NOT NULL,
...
INSERT INTO SpotifyClone.planos (plano_name, valor_plano)
	VALUES
		('gratuito', 0),
		('universitário', 5.99),
		('pessoal', 6.99),
...
INSERT INTO SpotifyClone.usuario (user_name, user_age, data_assinatura, plano_id)
	VALUES
...
INSERT INTO SpotifyClone.musicas (musica_name, musica_duracao, album_id)
	VALUES
	  ('Soul For Us', 200, 1),
...
INSERT INTO SpotifyClone.usuario_artista (user_id, artista_id)
	VALUES
	  (1, 1),
	  (1, 4),
	  (1, 3),
...
INSERT INTO SpotifyClone.usuario_musicas (user_id, musica_id, data_reproducao)
	VALUES
