-- 1. Monte uma query usando o MOD juntamente com o IF 
	-- para descobrir se o valor 15 é par ou ímpar. 
...
-- 2. Temos uma sala de cinema que comporta 220 pessoas. 
	-- Quantos grupos completos de 12 pessoas podemos
    -- levar ao cinema sem que ninguém fique de fora?
SELECT 220 DIV 12;
	-- 18 grupos

-- 3. Utilizando o resultado anterior, responda à seguinte pergunta:
