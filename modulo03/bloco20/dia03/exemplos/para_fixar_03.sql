...
-- 2. Mostre o e-mail dos clientes com os address_id 
	-- 172, 173, 174, 175 e 176, 
...
SELECT COUNT(*) 'Quantidade de pagamentos' FROM payment
	WHERE DATE(payment_date) BETWEEN '2005-05-01' AND '2005-08-01';

-- 4. Mostre o título, ano de lançamento e duração do empréstimo
	-- de todos os filmes com a duração de empréstimo de 3 a 6. 
